// simul-juice-safe-v7-recovery.js
// Repoint of simul-juice-safe-v4-recovery.js at the DEPLOYED juice-safe-v7.
...
// simul-juice-safe-v7-recovery.js
//
// REPOINT of simul-juice-safe-v2-recovery.js at the DEPLOYED juice-safe-v7. The assertions are
...
//
// simul-juice-safe-v7-recovery.js
// The two owner-change escape hatches on the DEPLOYED SPV9K21....juice-safe-v7.
//
...
//
// Run: node simul-juice-safe-v7-recovery.js
...
async function main() {
  ...
  console.log("=== juice-safe-v7: 2FA transfer + inactivity recovery ===\n");

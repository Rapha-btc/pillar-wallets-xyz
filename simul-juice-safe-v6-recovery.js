// simul-juice-safe-v6-recovery.js
// Repoint of simul-juice-safe-v4-recovery.js at the DEPLOYED juice-safe-v6.
...
// simul-juice-safe-v6-recovery.js
//
// REPOINT of simul-juice-safe-v2-recovery.js at the DEPLOYED juice-safe-v6. The assertions are
...
//
// simul-juice-safe-v6-recovery.js
// The two owner-change escape hatches on the DEPLOYED SPV9K21....juice-safe-v6.
//
...
//
// Run: node simul-juice-safe-v6-recovery.js
...
const WALLET = `${DEPLOYER}.juice-safe-v6`;
...
async function main() {
  ...
  console.log("=== juice-safe-v6: 2FA transfer + inactivity recovery ===\n");

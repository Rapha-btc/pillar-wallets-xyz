...
const WALLET = `${D}.juice-safe-v4`;
const CORE = `${D}.fakfun-wallet-core`;
const API = "http://77.42.3.101/stacks-api";
const RP_ID = "juiceofbtc.com";

const ERR_UNAUTHORISED = 4001;      // err-unauthorised, juice-safe-v4.clar:57
...
call("set-verified-contract(juice-safe-v4)", D, CORE, "set-verified-contract", [principalCV(WALLET), noneCV()], ok);
call("onboard", FAKFUN_DEPLOYER, WALLET, "onboard",
  [pubkeyCV, standardPrincipalCV(OWNER), someCV(standardPrincipalCV(RECOVERY)), uintCV(100_000_000), uintCV(100_000)], ok);
...
// juice-safe-v4 and fakfun-wallet-v14, and that is not yet diagnosed. The

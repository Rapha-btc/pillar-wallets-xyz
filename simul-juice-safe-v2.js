// simul-juice-safe-v2.js
// Stake -> top-up -> unstake -> unlock on the DEPLOYED SPV9K21....juice-safe-v2.
//
...
async function main() {
  ...
  // juice-safe-v2 is DEPLOYED on mainnet -- run against the real bytes.
  ...
  console.log("=== juice-safe-v2: full check (stake, top-up, unstake) ===\n");

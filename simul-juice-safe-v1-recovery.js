// simul-juice-safe-v1-recovery.js
// The two owner-change escape hatches on the DEPLOYED SPV9K21....juice-safe-v1.
//
...
//
// Run: node simul-juice-safe-v1-recovery.js
...
const WALLET = `${DEPLOYER}.juice-safe-v1`;
...
async function main() {
  ...
  console.log("=== juice-safe-v1: 2FA transfer + inactivity recovery ===\n");

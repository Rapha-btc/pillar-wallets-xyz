// simul-fakfun-wallet-v11.js
// Stxer mainnet-fork harness for the DEPLOYED SPV9K21....fakfun-wallet-v11.
//
...
//
// Run: node simul-fakfun-wallet-v11.js
...
const FIXED_NAME = "fakfun-wallet-v11";
...
async function main() {
  ...
  // fakfun-wallet-v11 is DEPLOYED on mainnet -- run against the real bytes.
  call("set-verified-contract(fakfun-wallet-v11)", DEPLOYER, WALLET_CORE,
  ...
  console.log("=== fakfun-wallet-v11 - stxer harness (v8 -> v10 delta) ===\n");

// simul-juice-safe-v6.js
// Repoint of simul-juice-safe-v4.js at the DEPLOYED juice-safe-v6.
...
// simul-juice-safe-v6.js
//
// REPOINT of simul-juice-safe-v2.js at the DEPLOYED juice-safe-v6. The assertions are
...
//
// simul-juice-safe-v6.js
// Stake -> top-up -> unstake -> unlock on the DEPLOYED SPV9K21....juice-safe-v6.
//
...
async function main() {
  ...
  // juice-safe-v6 is DEPLOYED on mainnet -- run against the real bytes.
  ...
  console.log("=== juice-safe-v6: full check (stake, top-up, unstake) ===\n");

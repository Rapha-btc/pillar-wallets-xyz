// simul-juice-safe-v4.js
//
// REPOINT of simul-juice-safe-v2.js at the DEPLOYED juice-safe-v4. The assertions are
...
//
// simul-juice-safe-v4.js
// Stake -> top-up -> unstake -> unlock on the DEPLOYED SPV9K21....juice-safe-v4.
//
...
async function main() {
  ...
  // juice-safe-v4 is DEPLOYED on mainnet -- run against the real bytes.
  ...
  console.log("=== juice-safe-v4: full check (stake, top-up, unstake) ===\n");

// simul-juice-safe-v7-lifecycle.js
// Repoint of simul-juice-safe-v4-lifecycle.js at the DEPLOYED juice-safe-v7.
...
// simul-juice-safe-v7-lifecycle.js
//
// REPOINT of simul-juice-safe-v2-lifecycle.js at the DEPLOYED juice-safe-v7. The assertions are
...
//
// simul-juice-safe-v7-lifecycle.js
// Stxer mainnet-fork simulation for juice-safe-v7 + juice-safe-auth-helpers-v1,
...
//
// Run: node simul-juice-safe-v7.js
...
// -- contracts ---------------------------------------------------------------
const WALLET_NAME = "juice-safe-v7";
...
async function main() {
  ...
  call("set-verified-contract(juice-safe-v7)", DEPLOYER, WALLET_CORE,
  ...
  call("onboard(pubkey, OWNER, some(RECOVERY), thresholds)", FAKFUN_DEPLOYER, WALLET,
    ...
    [pubkeyCV, standardPrincipalCV(OWNER), standardPrincipalCV(RECOVERY),
     uintCV(STX_THRESHOLD), uintCV(SBTC_THRESHOLD), uintCV(144)],
    okre);
  ...
  // -- run + verify ------------------------------------------------------------
  console.log("=== juice-safe-v7 (DEPLOYED) + juice-safe-auth-helpers-v1 - stxer harness ===\n");

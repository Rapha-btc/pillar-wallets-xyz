// simul-v16-full.js
// Repoint of simul-v14-full.js at the DEPLOYED fakfun-wallet-v16.
// onboard is unchanged here (pubkey only).
// simul-v14-full.js
// Stxer mainnet-fork harness for the DEPLOYED SPV9K21....fakfun-wallet-v16.
//
...
const FIXED_NAME = "fakfun-wallet-v16";
...
async function main() {
  ...
  // fakfun-wallet-v16 is DEPLOYED on mainnet -- run against the real bytes.
  call("set-verified-contract(fakfun-wallet-v16)", DEPLOYER, WALLET_CORE,
  ...
  console.log("=== fakfun-wallet-v16 - full harness + gas-counter assertions ===\n");

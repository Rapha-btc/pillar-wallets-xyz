// simul-tranche-attack-v6.js
// Repoint of simul-tranche-attack-v4.js at the DEPLOYED juice-safe-v6.
...
// simul-tranche-attack-v4.js
//
// REPOINT of simul-tranche-attack-v2.js at the DEPLOYED juice-safe-v6. The assertions are
...
//
// simul-juice-safe-v6-lifecycle.js
// Stxer mainnet-fork simulation for juice-safe-v6 + juice-safe-auth-helpers-v1,
...
//
// Run: node simul-juice-safe-v6.js
...
async function main() {
  ...
  // -- run + verify ------------------------------------------------------------
  console.log("=== juice-safe-v6 (DEPLOYED) + juice-safe-auth-helpers-v1 - stxer harness ===\n");

// simul-juice-safe-v4-recovery.js
//
// REPOINT of simul-juice-safe-v2-recovery.js at the DEPLOYED juice-safe-v4. The assertions are
...
//
// simul-juice-safe-v4-recovery.js
// The two owner-change escape hatches on the DEPLOYED SPV9K21....juice-safe-v4.
//
...
//
// Run: node simul-juice-safe-v4-recovery.js
...
const WALLET = `${DEPLOYER}.juice-safe-v4`;
...
async function main() {
  ...
  console.log("=== juice-safe-v4: 2FA transfer + inactivity recovery ===\n");

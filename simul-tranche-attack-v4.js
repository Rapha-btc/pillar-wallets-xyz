...
//
// REPOINT of simul-tranche-attack-v2.js at the DEPLOYED juice-safe-v4. The assertions are
...
//
// simul-juice-safe-v4-lifecycle.js
// Stxer mainnet-fork simulation for juice-safe-v4 + juice-safe-auth-helpers-v1,
...
//
// Run: node simul-juice-safe-v4.js
...
// -- contracts ---------------------------------------------------------------
const WALLET_NAME = "juice-safe-v4";
...
async function main() {
  ...
  call("set-verified-contract(juice-safe-v4)", DEPLOYER, WALLET_CORE,
  ...
  // -- run + verify ------------------------------------------------------------
  console.log("=== juice-safe-v4 (DEPLOYED) + juice-safe-auth-helpers-v1 - stxer harness ===\n");

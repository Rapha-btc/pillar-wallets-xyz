...
async function main() {
  ...
  b.withSender(DEPLOYER).addContractDeploy({
    contract_name: "faktory-smart-trait-v1",
    source_code: read("faktory-smart-trait-v1.clar"),
    clarity_version: ClarityVersion.Clarity5,
  });
  plan.push({ kind: "deploy", label: "deploy faktory-smart-trait-v1" });
  b.withSender(DEPLOYER).addContractDeploy({
    contract_name: "smart-execute-auth-helper",
    source_code: read("smart-execute-auth-helper.clar"),
    clarity_version: ClarityVersion.Clarity5,
  });
  ...
  plan.push({ kind: "deploy", label: "deploy usdcx-sbtc-swap extension" });
  b.withSender(DEPLOYER).addContractDeploy({
    contract_name: FIXED_NAME,
    source_code: read("fakfun-wallet-v18.clar"),

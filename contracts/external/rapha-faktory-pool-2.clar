;; SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.rapha-faktory-pool-2
...
(impl-trait 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.charisma-traits-v1.sip010-ft-trait)
    ...
    (define-public (initialize-pool (lowest uint) (highest uint))
      (begin
         ...
         (try! (contract-call? 'SP14ZYP25NW67XZQWMCDQCGH9S178JT78QJYE6K37.rapha-faktory transfer highest contract-caller CONTRACT none))

...
// ---------------------------------------------------------------------------
// DEPLOYED-BYTES security check for the H-01 fix. Deploys the FIXED clarity-5-webauthn-v4 and
...
async function main() {
  ...
  // contracts already DEPLOYED on mainnet (fork includes them); exercise real bytes.

...
//
// Staking lifecycle on the DEPLOYED juice-safe-v4 and fakfun-wallet-v14.
...
// flow that harness already implements). This file is juice-safe-v4.
const TARGETS = ["juice-safe-v4"];
const okre = /^\(ok/;

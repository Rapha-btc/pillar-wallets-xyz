// simul-juice-safe-v2-lifecycle.js
// Stxer mainnet-fork simulation for juice-safe-v2 + juice-safe-auth-helpers-v1,
...
//
// Run: node simul-juice-safe-v2.js
...
// -- contracts ---------------------------------------------------------------
const WALLET_NAME = "juice-safe-v2";
...
async function main() {
  ...
  call("set-verified-contract(juice-safe-v2)", DEPLOYER, WALLET_CORE,
  ...
  // -- run + verify ------------------------------------------------------------
  console.log("=== juice-safe-v2 (DEPLOYED) + juice-safe-auth-helpers-v1 - stxer harness ===\n");

// fakfun-wallet-v16-gaps.test.ts -- the error branches the other suites left open.
//
// Run: npx vitest run tests/fakfun-wallet-v16-gaps.test.ts -- --manifest tests/cl-v16/Clarinet.toml
//

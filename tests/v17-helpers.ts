// Shared plumbing for the fakfun-wallet-v17 suites.
//
// v16 is published by deployV17() rather than pulled as a requirement: clarinet
...
export const WD = process.env.V17_DEPLOYER ?? D;
export const FAKFUN_DEPLOYER = "SP28MP1HQDJWQAFSQJN2HBAXBVP7H7THD1W2NYZVK";
export const WALLET = `${WD}.fakfun-wallet-v17`;
export const CORE = `${D}.fakfun-wallet-core-v2`;
...
export function deployV17() {
  ...
  if (process.env.V17_DEPLOYER) return;

// juice-safe-v7-gaps.test.ts -- the real gaps that measured LINE coverage exposed.
//
// Run: npx vitest run tests/juice-safe-v7-gaps.test.ts -- --manifest tests/cl-v7/Clarinet.toml
//
...
//      Three sites: juice-safe-v7.clar:643, :670, :720.

// juice-safe-v7-allowance.test.ts -- a TOOLING guard, not a contract test.
//
// Run: npx vitest run tests/juice-safe-v7-allowance.test.ts -- --manifest tests/cl-v7/Clarinet.toml
//
// PROVES that clarinet's simnet does NOT enforce the SIP-044 (with-staking N)
// allowance. tests/cl-v7/contracts/zz-allowance-probe.clar stakes a real 51k STX

// juice-safe-v6-surface.test.ts -- the rest of the public surface.
//
// tests/juice-safe-v6.test.ts covers the v6 DELTA (onboard guards, the config
...
//
// Run: npx vitest run tests/juice-safe-v6-surface.test.ts -- --manifest tests/cl-v6/Clarinet.toml
//

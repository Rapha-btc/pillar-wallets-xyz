// fakfun-wallet-v17-new.test.ts -- the surface v16 has that juice-safe-v6 does not.
//
// Run: npx vitest run tests/fakfun-wallet-v17-new.test.ts -- --manifest tests/cl-v17/Clarinet.toml
//
...
// tests/cl-v17/contracts/zz-extension.clar is deliberately hostile so that claim is

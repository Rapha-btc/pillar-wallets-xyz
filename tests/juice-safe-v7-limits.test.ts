// juice-safe-v7-limits.test.ts -- the guard rails the other four suites left alone.
//
// Run: npx vitest run tests/juice-safe-v7-limits.test.ts -- --manifest tests/cl-v7/Clarinet.toml
//
...
//     -- see juice-safe-v7.clar:1334 -- so the lock freezes the PASSKEY and leaves the

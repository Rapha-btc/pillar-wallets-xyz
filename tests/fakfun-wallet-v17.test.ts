// fakfun-wallet-v17.test.ts -- Clarinet scenarios against the DEPLOYED contract.
//
// Run:  npx vitest run tests/fakfun-wallet-v17.test.ts -- --manifest tests/cl-v17/Clarinet.toml
//
// v16 is published by deployV17() rather than pulled as a requirement, because
...
// V17_DEPLOYER lets the coverage harness (tests/cl-v17-cov) publish the wallet
...
// --- setup ---------------------------------------------------------------
const V16_SRC = fs.readFileSync("contracts/fakfun-wallet-v17.clar", "utf8");
...
function deployV17() {
  if (process.env.V17_DEPLOYER) return;   // already published by the coverage plan
  expect(simnet.deployContract("fakfun-wallet-v17", V16_SRC,
...
describe("fakfun-wallet-v17: init and admin seating", () => {
...
describe("fakfun-wallet-v17: no post-init passkey registration", () => {
...
describe("fakfun-wallet-v17: config change spans two different factors", () => {
...
describe("fakfun-wallet-v17: max-gas and thresholds", () => {
...
describe("fakfun-wallet-v17: never its own admin", () => {

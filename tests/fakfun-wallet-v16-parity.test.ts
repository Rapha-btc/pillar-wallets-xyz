// fakfun-wallet-v16-parity.test.ts -- the surface v16 SHARES with juice-safe-v6.
//
// Run: npx vitest run tests/fakfun-wallet-v16-parity.test.ts -- --manifest tests/cl-v16/Clarinet.toml
//

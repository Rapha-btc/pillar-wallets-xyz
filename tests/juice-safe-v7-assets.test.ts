// juice-safe-v7-assets.test.ts -- the SUCCESS paths, not just the rejections.
//
// Run: npx vitest run tests/juice-safe-v7-assets.test.ts -- --manifest tests/cl-v7/Clarinet.toml
//
...
// for real.
//
// Also adds a live gas station (tests/cl-v7/contracts/zz-gas-station.clar) so the
